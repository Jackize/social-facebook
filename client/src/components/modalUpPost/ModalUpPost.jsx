...
import { Box, Button, ButtonGroup, Divider, IconButton, Modal, Stack, TextField, Typography, useTheme } from "@mui/material";
            ...
            <Box sx={style}>
                <Stack direction="column">
                    <Box>
                        ...
                        <Divider />
                        <TextField fullWidth multiline rows={4} variant="filled" sx={{ margin: "30px 0 30px 0" }} onChange={(e) => setContent(e.target.value)} value={content} />
                        {file && (
                            <img
                        ...
                        <ButtonGroup fullWidth sx={{ marginBottom: "-30px", marginTop: "10px" }}>
